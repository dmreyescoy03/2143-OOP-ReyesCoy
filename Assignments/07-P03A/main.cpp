...
* 
*  Description:
*       Program that does Rock,Paper,Scissors,Lizard,Spock using Emojis
*       as each object. The rules are set in This is a part one of our 
*       main project to help with defining weapons to our characters. 
*
*
* 
*  Usage:
